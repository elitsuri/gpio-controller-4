...
> GPIO Controller: C GPIO management daemon for Linux SBCs with REST API
...
## 🧰 Tech Stack
C, FreeRTOS, SQLite, CMake

## 🏗️ Architecture
Three-tier architecture: C, FreeRTOS backend, native frontend, PostgreSQL database. Containerized with Docker.
...
git clone https://github.com/elitsuri/gpio-controller
cd gpio-controller
